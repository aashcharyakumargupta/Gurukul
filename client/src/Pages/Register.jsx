    ...
    <>
      <div className='main flex flex-col md:h-screen h-screen bg-blue-600 w-full md:flex-row md:overflow-y-hidden text-sm'>
        ...
        <div className='bg-white w-full h-full md:w-3/4 md:h-screen'>
          ...
          <form onSubmit={handleSubmit(handleOnSubmitAdmin, onError)} className='px-10 -mt-5 md:p-10 mx-auto'>
            <div className='mx-auto flex flex-col'>
              <label htmlFor="adminName" className='text-black  mb-1'>User Name</label>
              <input
                {...register('adminName', {
              ...
              <label htmlFor="email" className='text-black '>User Email</label>
              <input
                {...register('email', {
            ...
            <div className='mt-5'>
              <input
                {...register("checkbox", { required: "Please click on checkbox" })}
                type="checkbox"
                name='checkbox'
                id='checkbox' />
            ...
            <button className='bg-cyan-500 hover:bg-cyan-700 text-white mt-5 py-4 font-bold w-full' onClick={handleRegister}> Register</button>
